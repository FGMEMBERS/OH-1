...
# liveries =========================================================
# aircraft.livery.init("Aircraft/OH-1/Models/liveries",
#		"sim/model/OH-1/livery/variant");
...
aircraft.light.new("sim/model/OH-1/lighting/strobes", [0.015, 1.985], strobe_switch);


# beacons ===========================================================
var beacon_switch = props.globals.getNode("controls/lighting/beacon", 1);
aircraft.light.new("sim/model/OH-1/lighting/beacon-top", [0.10, 0.90], beacon_switch);
...
var nav_lights = props.globals.getNode("sim/model/OH-1/lighting/nav-lights", 1);
...
# engines/rotor =====================================================
var state = props.globals.getNode("sim/model/OH-1/state");
...
var turbine = props.globals.getNode("sim/model/OH-1/turbine-rpm-pct", 1);
var torque_pct = props.globals.getNode("sim/model/OH-1/torque-pct", 1);
...
var inside_volume = props.globals.getNode("sim/model/OH-1/inside_volume", 1);
var outside_volume = props.globals.getNode("sim/model/OH-1/outside_volume", 1);
...
var rotor_step = props.globals.getNode("sim/model/OH-1/rotor-step-deg");
